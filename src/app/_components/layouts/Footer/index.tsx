...
const linkData = [
  ...
  { text: "¥＄グラフ", link: "/graph/ja-fgn" },
  { text: "¥グラフ", link: "/graph/ja" },
  { text: "＄グラフ", link: "/graph/fgn" },
];

export const Footer: FC = () => {
  const pathname = usePathname();
  return (
    <footer className="z-50 flex h-[50px] w-full border-y border-solid border-gray-300 bg-[#f8f9fb] sm:fixed sm:bottom-0 md:top-[750px] md:w-[768px]">
