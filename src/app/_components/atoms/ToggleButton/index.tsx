  ...
  function ToggleButtonBase({ ...props }, ref) {
    ...
    return (
      <div className="flex gap-2">
        ...
        <label className="relative h-[15px] w-[30px] cursor-pointer  rounded-[50px] bg-[#4bd865] ">
          <input
            ref={ref}
            id={id}
            type="checkbox"
          ...
          <label
            htmlFor={id}
            className="absolute left-0 h-[15px] w-[15px] rounded-full bg-white [box-shadow:0_0_5px_rgb(0_0_0_/_20%)] peer-checked:left-[15px]"
          ></label>
        </label>
