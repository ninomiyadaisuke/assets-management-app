...
export const Switch = forwardRef<HTMLButtonElement, Props>(function SwitchBase(
  ...
  return (
    ...
    >
      ...
      <RadixSwitch.Thumb className="absolute left-[10.5px] top-[2.5px] block transition-opacity duration-75 ease-in-out data-[state=unchecked]:opacity-0">
        ¥
      </RadixSwitch.Thumb>
      <RadixSwitch.Thumb className="absolute right-[8.2px] top-[2.5px] block transition-opacity duration-75 ease-in-out data-[state=checked]:opacity-0">
        ＄
      </RadixSwitch.Thumb>
    </RadixSwitch.Root>
  );
